...
const Modal = () => {
    ...
    const [subjectInfo,setSubjectInfo] = useState({
        title:"",description:"",subjectField:"",picture:""
    })
        ...
        <div className='relative mt-4 sm:mt-0 bg-pfe-white p-4 w-11/12 md:w-8/12 lg:w-7/12 xl:w-6/12 flex flex-col items-center  rounded-lg ' >
            ...
            <form className='flex flex-col gap-4' onSubmit={handleSubmit} >
                ...
                <div className='p-2 border-[1px] border-bg text-[gray] flex flex-wrap justify-between gap-4'>
                    ...
                    <textarea  rows="10" placeholder='Descrition...' className='w-full outline-none p-2 border-[1px] text-[gray] border-bg rounded-lg' name="description" value={subjectInfo.description} onChange={handleChange}></textarea>
