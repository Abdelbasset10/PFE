...
import { addBinome, allStudents, getStudent } from '../redux/features/studentSlice'
...
const Profile = () => {
    ...
    useEffect(()=>{   
            ...
            if(user?.hisBinome){
                dispatch(getStudent(user?.hisBinome))
            }
        

    },[user?.hisBinome])
    console.log(user?.hisBinome)
            ...
            <div className='flex flex-col gap-6 ' >
                <div className='flex flex-col gap-4' >
                    ...
                    <div className='flex justify-between items-center' >
                        ...
                        {User?.type ==="student" && !user?.isBinome && User?._id !== id && (
                ...
                <div className='flex flex-col ' >
                    ...
                    {user.type === "teacher" && (
                        <div >
                            ...
                            <p>Students : <span className='text-pfe-blue hover:underline cursor-pointer'> {user.studentsVision.length === 0 ? 'No Students yet' : user.studentsVision.map((s,index)=>(
                                <div key={index} >
                                    <p>{s}</p>
                                    <br />
                                </div>
                    ...
                    {user.type ==="student" && (
                        <div>
                            ...
                            <p>Encadreur : <span className='text-pfe-blue hover:underline cursor-pointer' >{user?.hisTeacher.length > 0 ? user?.hisTeacher.map((t)=> (t)) : "Don't Has Encadreur yet"}</span></p>
