...
const {getAllStudents, getStudent, updateStudent, deleteStudent, getAllNoBinomes, getAllBinomes, searchStudent, searchNoBinome, addBinome, BeNoBinome, addTeacher, removeTeacher, getStudentsBySection} = require('../controllers/student')
