...
const {getAllStudents, getStudent, updateStudent, deleteStudent, getAllNoBinomes, getAllBinomes, searchStudent, addBinome, BeNoBinome, addTeacher, removeTeacher, getStudentsBySection} = require('../controllers/student')
